          ...
          <Section style={{ paddingBottom: "20px" }}>
            <Row>
              ...
              <Text style={paragraph}>
                Thank you for your interest in our {brochureTitle}. We&apos;re
                excited to share this valuable information with you!
              </Text>
              <Text style={paragraph}>
                You can find your free brochure attached to this email. We hope
