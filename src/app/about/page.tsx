...
export default function About() {
  const expertise = [
    { title: "Sustainability Strategy", description: "Developing tailored roadmaps aligned with business goals.", icon: Leaf },
    { title: "Climate Change Mitigation", description: "Implementing innovative solutions to reduce carbon emissions.", icon: TrendingUp },
    { title: "Carbon Market Expertise", description: "Providing guidance on carbon credit generation and trading.", icon: Briefcase },
    { title: "Technology-Driven Solutions", description: "Leveraging AI and blockchain for sustainable practices.", icon: Zap },
  ]
    ...
    <div className="space-y-24">
      ...
      <section className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl font-bold mb-6 text-emerald-600">Our Story</h2>
