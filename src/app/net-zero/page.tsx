...
export default function NetZero() {
  const benefits = [
    { title: "Enhanced brand reputation", description: "Position your company as a responsible and sustainable leader." },
    { title: "Increased competitiveness", description: "Gain a competitive edge in the market." },
    { title: "Reduced risks", description: "Mitigate climate-related risks and ensure long-term business resilience." },
    { title: "Financial gains", description: "Improve your bottom line through cost savings and increased efficiency." },
    { title: "Stronger stakeholder relationships", description: "Foster trust and engagement with investors, customers, employees, and communities." },
    { title: "Environmental impact", description: "Contribute to global efforts in combating climate change and preserving our planet." },
  ]

  const process = [
    { title: "1. Comprehensive Assessment", description: "We conduct a thorough evaluation of your current sustainability performance to identify key areas for improvement." },
    { title: "2. Ambitious Goal Setting", description: "Together, we develop achievable sustainability goals that align with your business objectives." },
    { title: "3. Customized Strategy Development", description: "We create a tailored roadmap outlining the steps necessary to achieve your goals." },
    { title: "4. Implementation Support", description: "Our team provides guidance and resources to help you execute your sustainability strategy effectively." },
    { title: "5. Monitoring and Reporting", description: "We help you track progress, measure impact, and communicate results to stakeholders." },
    { title: "6. Continuous Improvement", description: "We work with you to refine and adapt your strategy as needed, ensuring long-term success." },
  ]
