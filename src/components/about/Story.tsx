...
const Story = () => {
  return (
    <div className="relative h-screen flex items-center justify-center bg-white -100 py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
      {/* Background Patch Animation */}
      <motion.div
        className="absolute top-48 left-1/4 w-[500px] h-[500px] bg-gradient-to-r from-green-400 to-blue-500 rounded-full filter blur-3xl opacity-30"
      ...
      <motion.div
        className="absolute bottom-40 right-1/4 w-[400px] h-[400px] bg-gradient-to-r from-green-300 to-green-900 rounded-full filter blur-2xl opacity-30"
        initial={{ scale: 0.5, x: "50%", y: "50%", opacity: 0 }}
        animate={{ scale: 1, opacity: 0.5 }}
        transition={{
          duration: 6,
