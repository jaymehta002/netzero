...
export default function CarbonCredits() {
  const benefits = [
    { title: "Environmental impact", description: "Reduce your carbon footprint and contribute to a cleaner, healthier planet.", icon: Leaf },
    { title: "Regulatory compliance", description: "Meet your carbon emissions reduction targets and avoid penalties.", icon: BarChart },
    { title: "Enhanced brand reputation", description: "Demonstrate your commitment to sustainability and corporate social responsibility.", icon: Zap },
    { title: "Financial returns", description: "Generate potential financial returns through carbon credit trading.", icon: Sprout },
  ]

  const approach = [
    { title: "Project Development", description: "We identify and develop high-quality carbon credit projects, such as reforestation, renewable energy, and energy efficiency initiatives." },
    { title: "Verification", description: "We ensure that our projects meet rigorous standards for carbon credit generation and are verified by independent third parties." },
    { title: "Issuance and Trading", description: "We facilitate the issuance and trading of carbon credits, allowing you to offset your emissions and support sustainable development." },
  ]

  const projects = [
    { title: "Reforestation Projects", description: "Plant trees in degraded forests to sequester carbon and restore ecosystems." },
    { title: "Renewable Energy Projects", description: "Support the development of solar, wind, and other renewable energy sources." },
    { title: "Energy Efficiency Projects", description: "Implement energy-saving measures to reduce emissions and improve efficiency." },
    { title: "Sustainable Agriculture Projects", description: "Promote sustainable farming practices to reduce deforestation and improve soil health." },
  ]
      ...
      <section className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row items-stretch justify-center space-y-8 md:space-y-0 md:space-x-8">
          {approach.map((step, index) => (
            <Card key={index} className="flex-1 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
              <CardHeader>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {projects.map((project, index) => (
              <Card key={index} className="bg-white text-gray-800 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                <CardHeader>
