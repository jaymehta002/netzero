...
const TerrasolsSections = () => {
  ...
  const trustIndicators = [
    ...
    // { icon: Award, label: "Certified", value: "ISO 14064" },
    { icon: Zap, label: "Fast", value: "24h Processing" },
    { icon: Globe, label: "Global", value: "50+ Countries" }
  ];

  return (
    <div className="bg-gradient-to-br from-gray-50 via-white to-emerald-50 py-20">
      {/* Why Choose Terrasols Section */}
      <div className="max-w-7xl mx-auto px-4 mb-24">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-emerald-100 text-emerald-800 px-4 py-2 rounded-full font-medium mb-6">
            ...
            return (
              ...
              >
                <div className={`relative bg-white rounded-2xl p-8 shadow-lg border border-gray-100 transition-all duration-500 hover:shadow-2xl hover:-translate-y-3 overflow-hidden ${
                  ...
                  {/* Background Pattern */}
                  <div className={`absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-emerald-50 to-green-50 opacity-60 rounded-bl-full transition-transform duration-500 group-hover:scale-150`} />
                  ...
                  {/* Icon */}
                  <div className={`relative inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-green-500 to-emerald-500 rounded-xl shadow-lg mb-6 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3`}>
                  ...
                  {/* Decorative Corner */}
                  <div className="absolute -bottom-2 -right-2 w-8 h-8 bg-gradient-to-tl from-emerald-200 to-green-200 rounded-full opacity-50 transition-transform duration-500 group-hover:scale-150" />
                </div>
              </div>
            );
          })}
        ...
        {/* <div className="flex flex-col sm:flex-row gap-4 justify-center mt-12">
          <button className="bg-gradient-to-r from-green-600 to-emerald-600 text-white px-8 py-4 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2">
            Learn About Our Verification
            <ArrowRight className="w-4 h-4" />
          </button>
          <button className="bg-white text-green-700 border-2 border-green-500 px-8 py-4 rounded-xl font-semibold hover:bg-green-50 transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2">
            Partner With Us
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-green-100 to-emerald-100 text-green-800 px-4 py-2 rounded-full font-medium mb-6">
            ...
            return (
              ...
              >
                <div className={`relative bg-white rounded-2xl p-8 shadow-lg border border-gray-100 transition-all duration-500 hover:shadow-2xl hover:-translate-y-4 overflow-hidden min-h-[500px] flex flex-col ${
                  ...
                  {/* Icon */}
                  <div className={`relative inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-green-500 to-emerald-500 rounded-xl shadow-lg mb-6 transition-all duration-300 group-hover:scale-110 group-hover:rotate-6`}>
                    <IconComponent className="w-8 h-8 text-white" />
                  </div>

                  {/* Audience Tag */}
                  <div className="inline-block bg-gradient-to-r from-green-100 to-emerald-100 text-green-700 px-3 py-1 rounded-full text-xs font-medium mb-4 w-fit">
                    {option.audience}
                  </div>
                  ...
                  <p className="text-green-600 font-semibold mb-4 relative z-10">
                    {option.subtitle}
                  </p>
                  <p className="text-gray-600 mb-6 leading-relaxed relative z-10 flex-grow">
                    {option.description}
                  </p>
                  ...
                  <button className={`w-full bg-gradient-to-r from-green-600 to-emerald-600 text-white py-4 px-6 rounded-xl font-semibold shadow-lg transition-all duration-300 hover:shadow-xl flex items-center justify-center gap-2 relative z-10 mt-auto ${
                  ...
                  {/* Decorative Elements */}
                  <div className="absolute -top-8 -right-8 w-16 h-16 bg-gradient-to-br from-green-200/50 to-emerald-200/50 rounded-full opacity-60 transition-transform duration-500 group-hover:scale-150" />
                  <div className="absolute -bottom-4 -left-4 w-12 h-12 bg-gradient-to-br from-emerald-200/50 to-green-200/50 rounded-full opacity-60 transition-transform duration-500 group-hover:scale-125" />
        ...
        <div className="mt-20 bg-gradient-to-r from-green-900 to-emerald-900 rounded-2xl p-8 text-white shadow-2xl">
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold mb-2">Trusted by Industry Leaders</h3>
            <p className="text-green-200">Join thousands who are already making a difference</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center group">
              <div className="text-4xl font-bold mb-2 bg-gradient-to-r from-green-300 to-emerald-300 bg-clip-text text-transparent">
                10,000+
              </div>
              <div className="text-green-200 text-sm">Carbon Credits Generated</div>
              <div className="w-12 h-0.5 bg-gradient-to-r from-green-400 to-emerald-400 mx-auto mt-2 transition-transform duration-300 group-hover:scale-150" />
            </div>
            <div className="text-center group">
              <div className="text-4xl font-bold mb-2 bg-gradient-to-r from-green-300 to-emerald-300 bg-clip-text text-transparent">
                500+
            ...
            <div className="text-center group">
              ...
              <div className="text-green-200 text-sm">Acres Regenerated</div>
              <div className="w-12 h-0.5 bg-gradient-to-r from-green-400 to-emerald-400 mx-auto mt-2 transition-transform duration-300 group-hover:scale-150" />
            </div>
            <div className="text-center group">
              <div className="text-4xl font-bold mb-2 bg-gradient-to-r from-green-300 to-emerald-300 bg-clip-text text-transparent">
        ...
        {/* Final CTA Section */}
        <div className="mt-16 text-center bg-gradient-to-r from-gray-50 to-green-50 rounded-2xl p-8 border border-green-100">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact">
            <button className="bg-gradient-to-r from-green-600 to-emerald-600 text-white px-8 py-4 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
              Get Started Today
            </button>
            </Link>
            <Link href="/contact">
            <button className="bg-white text-green-700 border-2 border-green-500 px-8 py-4 rounded-xl font-semibold hover:bg-green-50 transition-all duration-300 hover:scale-105">
