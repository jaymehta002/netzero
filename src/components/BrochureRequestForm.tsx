      ...
      <Card className="w-full max-w-2xl shadow-lg">
        <CardHeader className="bg-green-600 text-white rounded-t-lg">
          ...
          <CardDescription className="text-center text-green-100 mt-2">
            Request our eco-friendly brochure and plant the seeds of a
            sustainable future.
          </CardDescription>
        </CardHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {fields.map((field) => (
              <div key={field}>
                <Label
                  htmlFor={field}
                  className="text-lg text-green-700 capitalize"
                >
                ...
                <Input
                  ...
                  required
                  placeholder={
                    field === "phone" ? "+1234567890" : `Enter your ${field}`
                  }
            ...
            >
              {formState.isSubmitting
                ? "Planting..."
                : "Get Your Eco-Friendly Brochure"}
            </Button>
          </form>
        </CardContent>
          ...
          {formState.success ? (
            <div className="flex items-center space-x-2 text-green-600 w-full justify-center py-2">
              ...
              <span className="text-lg">
                Success! Your eco-friendly brochure is on its way.
              </span>
            </div>
          ) : (
