      ...
      <body className={`${inter.className} bg-white text-gray-800`}>
          ...
          <nav className="container mx-auto px-4 py-4">
            <div className="flex justify-between items-center">
              ...
              <div className="hidden md:flex space-x-6">
                ...
                <NavLink href="/net-zero">Net Zero</NavLink>
                <NavLink href="/carbon-credits">Carbon Credits</NavLink>
            ...
            {isMenuOpen && (
              ...
              >
                ...
                <NavLink href="/net-zero" mobile>
                  Net Zero
                </NavLink>
                <NavLink href="/carbon-credits" mobile>
                  Carbon Credits
                </NavLink>
        ...
        <footer className="bg-primary text-white p-8 mt-16">
          <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">Terrasols.earth</h3>
              <p>Leveraging Sustainability Innovation for a Net-Zero Future</p>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/net-zero" className="hover:underline">
                    Net Zero
                  </Link>
                </li>
                <li>
                  <Link href="/carbon-credits" className="hover:underline">
                    Carbon Credits
                  </Link>
                </li>
                <li>
